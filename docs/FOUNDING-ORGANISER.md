...
- Staff/test workspaces never get founding: `rosie@the-networker.co.uk`, `rosie@thenetworkerhub.com`, `jamie@thenetworkerhub.com`, `catherine@thenetworkerhub.com`, `pips249@gmail.com` — groups they create or claim are marked `is_internal` and excluded from public founding strips (migration `258_staff_founding_excluded.sql`).
