...
**File storage (signed PDFs):** Desktop folder `Company records: data protection: DPAs : 2026` — **not in git**
...
| Provider | Mechanism | Effective date | Completed by | PDF filename (in company folder) | Status |
|----------|-----------|----------------|--------------|----------------------------------|--------|
| Stripe | Incorporated in [Stripe Services Agreement](https://stripe.com/gb/legal/ssa) | 2026-07-10 | Catherine Hancher | `STRIPE_DPA_2025-Nov-18_.pdf` | ☑ |
...
| Role | Name | Date all filed |
|------|------|----------------|
| Director / Ops | Catherine Hancher | 10 July 2026 |
