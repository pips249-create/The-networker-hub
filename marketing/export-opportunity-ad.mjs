/**
 * Export business opportunities LinkedIn ad as MP4.
 * Usage: node export-opportunity-ad.mjs
 */
...
const size = 1080;
const htmlPath = path.join(__dirname, 'linkedin-ad-opportunities.html');
const outDir = path.join(__dirname, 'exports');
const outName = 'business-opps-browse.mp4';
...
const rawMp4 = path.join(outDir, 'opps-raw.mp4');
