...
const HUB_STRIPE_CATALOG = [
  {
    ...
    description: 'Powered by hero on /events/ — exclusive monthly placement',
    amountPence: 200000,
    billing: 'recurring',
    interval: 'month',
  ...
  },
  {
    ...
    description: 'Sidebar mini sponsor slot on event detail pages',
    amountPence: 60000,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: true,
  ...
  },
  {
    ...
    description: 'Powered by hero on /events/ Organisers tab',
    amountPence: 100000,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: true,
  ...
  },
  {
    ...
    productMetadata: {
      ...
      cms_slot: 'organiser_page_carousel_ads',
    },
    paymentLinkMetadata: {
      checkout_type: 'hub_sponsorship',
      revenue_category: 'browse_organisers',
  ...
  },
  {
    ...
    description: 'Powered by hero on /opportunities/',
    amountPence: 200000,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: true,
  ...
  {
    key: 'group_update_credits_1',
    priceEnvVar: 'STRIPE_GROUP_UPDATE_CREDITS_1_PRICE_ID',
    productName: 'Monthly group update — 1 extra send',
    description: 'One extra organiser round-up email to attendees',
    amountPence: 900,
    billing: 'one_time',
    createPaymentLink: false,
    productMetadata: {
  ...
  {
    key: 'group_update_credits_3',
    priceEnvVar: 'STRIPE_GROUP_UPDATE_CREDITS_3_PRICE_ID',
    productName: 'Monthly group update — 3 extra sends',
    description: 'Three extra organiser round-up emails to attendees',
    amountPence: 2200,
    billing: 'one_time',
    createPaymentLink: false,
    productMetadata: {
  ...
  {
    key: 'connections_credits_1',
    priceEnvVar: 'STRIPE_CONNECTIONS_CREDITS_1_PRICE_ID',
    productName: 'Attendee round-up — 1 extra send',
    description: 'One extra branded guest-list email after the free round-up',
    amountPence: 900,
    billing: 'one_time',
    createPaymentLink: false,
    productMetadata: {
  ...
  {
    key: 'connections_credits_3',
    priceEnvVar: 'STRIPE_CONNECTIONS_CREDITS_3_PRICE_ID',
    productName: 'Attendee round-up — 3 extra sends',
    description: 'Three extra branded guest-list emails for more events',
    amountPence: 2200,
    billing: 'one_time',
    createPaymentLink: false,
    productMetadata: {
  ...
  },
  {
    ...
    description: 'One-time Premium Spotlight — up to 30 days on the opportunities browse page',
    amountPence: 5500,
    billing: 'one_time',
    createPaymentLink: false,
    productMetadata: {
  ...
  },
  {
    ...
    description: 'One-time Premium Spotlight — up to 30 days on the organisers browse page',
    amountPence: 2750,
    billing: 'one_time',
    createPaymentLink: true,
    productMetadata: {
  ...
  {
    key: 'connected_booking_starter',
    priceEnvVar: 'STRIPE_CONNECTED_BOOKING_STARTER_PRICE_ID',
    paymentLinkEnvVar: 'STRIPE_CONNECTED_BOOKING_STARTER_PAYMENT_LINK',
    productName: 'Connected booking — Starter',
    description: '1 organiser page — Connected booking intro offer (£19/mo ex VAT).',
    amountPence: 1900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
    productMetadata: {
      revenue_category: 'organisers',
      checkout_type: 'connected_booking',
      connected_booking_plan: 'starter',
    },
  },
  {
    key: 'connected_booking_growth',
    priceEnvVar: 'STRIPE_CONNECTED_BOOKING_GROWTH_PRICE_ID',
    paymentLinkEnvVar: 'STRIPE_CONNECTED_BOOKING_GROWTH_PAYMENT_LINK',
    productName: 'Connected booking — Growth',
    description: 'Up to 5 organiser pages — Connected booking intro offer (£39/mo ex VAT).',
    amountPence: 3900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
    productMetadata: {
      revenue_category: 'organisers',
      checkout_type: 'connected_booking',
      connected_booking_plan: 'growth',
    },
  },
  {
    key: 'connected_booking_scale',
    priceEnvVar: 'STRIPE_CONNECTED_BOOKING_SCALE_PRICE_ID',
    paymentLinkEnvVar: 'STRIPE_CONNECTED_BOOKING_SCALE_PAYMENT_LINK',
    productName: 'Connected booking — Scale',
    description: 'Up to 20 organiser pages — Connected booking intro offer (£99/mo ex VAT).',
    amountPence: 9900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
