...
const HUB_STRIPE_CATALOG = [
  ...
  },
  {
    ...
    description: '1 organiser page — Connected intro offer (£19/mo ex VAT).',
    amountPence: 1900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
  ...
  },
  {
    ...
    description: 'Up to 5 organiser pages — Connected intro offer (£39/mo ex VAT).',
    amountPence: 3900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
  ...
  },
  {
    ...
    description: 'Up to 20 organiser pages — Connected intro offer (£99/mo ex VAT).',
    amountPence: 9900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
