...
const HUB_STRIPE_CATALOG = [
  ...
  },
  {
    ...
    description: '1 group profile — list on The Networker UK, checkout on your site (£39/mo ex VAT).',
    amountPence: 3900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
  ...
  },
  {
    ...
    description: 'Up to 5 group profiles — Connected booking (£99/mo ex VAT).',
    amountPence: 9900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
  ...
  },
  {
    ...
    description: 'Up to 20 group profiles — Connected booking (£199/mo ex VAT).',
    amountPence: 19900,
    billing: 'recurring',
    interval: 'month',
    createPaymentLink: false,
