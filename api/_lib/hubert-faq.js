...
const FAQ_AEO_ENTRIES = [
  ...
  },
  {
    ...
    answer:
      'Approved organisers sign in and open the organiser dashboard at /organiser/ to create events and manage attendees. New networking groups can email hello@the-networker.co.uk with their group name, event format, and location for onboarding help.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Organisers use the dashboard at /organiser/. Platform and payment processing fees apply as shown in your dashboard and Stripe onboarding. Email hello@the-networker.co.uk for onboarding and fee details for your group.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Attendees pay a booking fee at checkout (4.5% + 20p per ticket, shown before payment). Organisers pay a 3% platform fee on gross ticket revenue plus Stripe processing, deducted in the payout breakdown.',
  },
  {
