    ...
    hints: {
      ...
      stripeWebhookEndpoint:
        stripe.checkoutReady && cron.isProduction
          ? `Stripe Dashboard webhook URL must be ${stripe.webhookEndpointUrl}. Stripe does not follow redirects — the-networker-hub.vercel.app now 308-redirects to www.thenetworkeruk.com and webhooks there fail.`
          : null,
