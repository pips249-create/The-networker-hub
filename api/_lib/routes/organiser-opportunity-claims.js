...
module.exports = async function handler(req, res) {
  ...
  const pendingClaims = await listPendingClaimOpportunitiesForSession(auth.session).catch(() => []);
  const canClaim =
  ...
  try {
    ...
    return json(res, 200, {
      ...
      message:
        'Thanks — we have removed this listing from your dashboard and notified our team to review it.',
