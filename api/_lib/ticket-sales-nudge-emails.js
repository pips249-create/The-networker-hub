...
async function sendOrganiserTicketSalesNudgeEmail({ event, organiser, to, nudgerEmail, nudgerName, message }) {
  ...
  const html =
    ...
    '<p style="color:#635c5e;font-size:15px;">If you are not the organiser for this group, sign in and use the organiser page claim flow, or contact hello@the-networker.co.uk.</p>' +
