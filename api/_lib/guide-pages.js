...
const GUIDE_PAGES = {
  ...
  'list-a-conference-or-exhibition': {
    ...
    steps: [
      ...
      { id: 'new-listing', name: 'Start a new listing', text: 'From the dashboard choose Add new → Event. Pick your organiser page, set format, venue, and dates. For multi-day conferences, select multiple dates on the calendar.' },
      ...
      { id: 'tickets', name: 'Set up tickets (free or paid)', text: 'Add delegate ticket tiers (early bird, standard, VIP, exhibitor, visitor, or free registration). Paid tickets require Connect Stripe under Revenue.' },
