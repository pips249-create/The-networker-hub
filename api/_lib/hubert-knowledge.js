...
const FALLBACK_REPLIES = [
  ...
  },
  {
    ...
    reply:
      'The guest visit programme is an optional add-on on the tickets step. Enable it to offer 1–3 complimentary visits so newcomers can try your group before buying a paid member ticket. Choose whether the allowance applies to this organiser page only, or across all your organiser pages. For member-only dates, tick “Member-only for this event” while keeping paid tickets live.',
  },
  {
