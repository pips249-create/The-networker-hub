...
const MEMBER_QUESTIONS = [
  ...
  { q: 'What is training on The Networker UK?', expect: /events|opportunities|focuses/i },
  ...
  { q: 'How much does The Networker UK make per ticket?', expect: /4\.5%|booking fee|platform and payment/i },
  ...
  { q: 'Can I save business opportunities to review later?', expect: /My account|Saved Opportunities/i },
  { q: 'How do I get alerts when new opportunities match my search?', expect: /saved search|email alert/i },
  { q: 'How do I add more than one date to a recurring event series?', expect: /calendar|selected dates|series|UK|Europe\/London|clock/i },
  { q: 'Why did my recurring event start times change by an hour?', expect: /UK|Europe\/London|clock|BST|save again|Edit event/i },
