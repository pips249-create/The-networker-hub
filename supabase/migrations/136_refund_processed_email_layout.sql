  ...
  <tr>
    <td class="email-outer-pad" align="center" style="padding:32px 16px;">
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <!-- Footer -->
        <tr>
          <td class="mobile-footer-pad" style="background:#0d1f3c;padding:32px 48px 34px;text-align:center;border-radius:0 0 20px 20px;">
            <a href="{{site_url}}/" style="text-decoration:none;display:inline-block;">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:15px;font-weight:400;color:rgba(255,255,255,0.72);margin:0;">
              ...
              &nbsp;&middot;&nbsp;
              <a href="{{site_url}}/legal-policies.html#refunds" style="color:#ebe0f0;text-decoration:none;font-weight:500;">Refunds</a>
              &nbsp;&middot;&nbsp;
              <a href="{{site_url}}/contact.html" style="color:#ebe0f0;text-decoration:none;font-weight:500;">Contact</a>
            </p>
          </td>
        </tr>
