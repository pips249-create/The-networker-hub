...
values (
  'booking_cancelled',
  'Booking cancelled',
  'Sent when an attendee cancels their own booking.',
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 16px;">
              <tr>
                <td style="width:52px;height:52px;background:#f1f5f9;border-radius:50%;text-align:center;vertical-align:middle;font-size:22px;line-height:52px;">&#10005;</td>
              </tr>
            </table>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">Booking cancelled</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:26px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">Your booking has been cancelled</h1>
              ...
              <tr>
                <td style="padding:24px;">
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="padding:0 0 10px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;line-height:1.5;">
                    ...
                    <tr>
                      <td style="padding:0;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;line-height:1.5;">
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid rgba(255,255,255,0.14);margin:16px 0 0;">
                    <tr>
                      ...
                      <td class="detail-cell" style="padding:14px 12px 0 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Paid</p>
                      ...
                      <td class="detail-cell" style="padding:14px 0 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Refund</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.4;">{{refund_status}}</p>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f5f0e8;border-radius:14px;border:1px solid rgba(194,153,209,0.35);">
              <tr>
                <td style="padding:22px 24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:2.5px;margin:0 0 6px;">Keep networking</p>
                  ...
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.65;margin:0 0 16px;">Browse upcoming events across the UK and find your next opportunity.</p>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Your ticket has been deactivated</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;border-left:1px solid rgba(255,255,255,0.12);border-right:1px solid rgba(255,255,255,0.12);vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Refund terms are set by the organiser</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Questions? <a href="mailto:hello@the-networker.co.uk" style="color:#ebe0f0;text-decoration:none;">hello@the-networker.co.uk</a></p>
                </td>
              </tr>
            </table>
          </td>
...
',
  array['user_name', 'user_email', 'event_name', 'event_date', 'event_time', 'ticket_name', 'amount_paid', 'organiser_name', 'refund_status', 'refund_eligible_row', 'no_refund_row', 'sponsor_row', 'site_url', 'logo_url'],
  'attendees'
)
...
values (
  'event_cancelled',
  'Event cancelled',
  'Sent to all booked attendees when an organiser cancels an event.',
  'Event cancelled – {{event_name}}',
  '<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta charset="UTF-8">
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 16px;">
              <tr>
                <td style="width:52px;height:52px;background:#fef3cd;border-radius:50%;text-align:center;vertical-align:middle;font-size:22px;line-height:52px;">&#9888;&#65039;</td>
              </tr>
            </table>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#b45309;text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">Event cancelled</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:26px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">This event has been cancelled</h1>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:400;color:#736b6e;line-height:1.7;margin:0;">
              ...
              <tr>
                <td style="padding:24px;">
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:14px;">
                    <tr>
                      <td style="background:rgba(180,83,9,0.25);border:1px solid rgba(251,191,36,0.4);border-radius:999px;padding:5px 14px;">
                        <span style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#fbbf24;text-transform:uppercase;letter-spacing:2px;">&#9888; Cancelled</span>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                      <td style="padding:0 0 0;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;line-height:1.5;">
                        <span style="color:rgba(255,255,255,0.55);">Organised by</span><br>
                        <span style="color:#ffffff;font-weight:600;">{{organiser_name}}</span>
                      </td>
                    </tr>
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid rgba(255,255,255,0.14);margin:16px 0 0;">
                    <tr>
                      <td class="detail-cell" style="padding:14px 12px 0 0;width:50%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Your ticket</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.4;">{{ticket_name}}</p>
                      </td>
        ...
        <tr>
          <td class="mobile-pad" style="padding:0 48px 20px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#fffbeb;border-radius:14px;border:1px solid #fcd34d;">
              <tr>
                <td style="padding:22px 24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#b45309;text-transform:uppercase;letter-spacing:2.5px;margin:0 0 6px;">About your refund</p>
                  ...
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.65;margin:0 0 16px;">{{refund_details}}</p>
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:12px;font-weight:500;color:#92400e;line-height:1.6;margin:0;background:#fef3cd;border-radius:8px;padding:12px 14px;">
        ...
        <tr>
          <td class="mobile-pad" style="padding:0 48px 20px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f5f0e8;border-radius:14px;border:1px solid rgba(194,153,209,0.35);">
              <tr>
                <td style="padding:22px 24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:2.5px;margin:0 0 6px;">Keep going</p>
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:600;color:#4a4446;margin:0 0 10px;line-height:1.35;">There are plenty more events to discover</p>
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.65;margin:0 0 16px;">Browse upcoming events and find your next opportunity to connect.</p>
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="background:#4a4446;border-radius:999px;">
                        <a href="{{site_url}}/events/" style="display:inline-block;padding:10px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">Browse upcoming events &rarr;</a>
        ...
        <tr>
          <td style="background:#4a4446;padding:22px 48px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Refunds are processed automatically</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;border-left:1px solid rgba(255,255,255,0.12);border-right:1px solid rgba(255,255,255,0.12);vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">No action needed from you</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Questions? <a href="mailto:hello@the-networker.co.uk" style="color:#ebe0f0;text-decoration:none;">hello@the-networker.co.uk</a></p>
                </td>
...
',
  array['user_name', 'user_email', 'event_name', 'event_date', 'event_time', 'ticket_name', 'amount_paid', 'organiser_name', 'refund_headline', 'refund_details', 'organiser_message_row', 'sponsor_row', 'site_url', 'logo_url'],
  'attendees'
)
on conflict (slug) do update set
  name = excluded.name,
...
values (
  'refund_processed',
  'Refund processed',
  'Sent when a refund has been issued to the attendee.',
  'Your refund is on its way – {{event_name}}',
  '<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta charset="UTF-8">
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 16px;">
              <tr>
                <td style="width:52px;height:52px;background:#dcfce7;border-radius:50%;text-align:center;vertical-align:middle;font-size:22px;line-height:52px;">&#10003;</td>
              </tr>
            </table>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#16a34a;text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">Refund processed</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:26px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">Your refund is on its way</h1>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:400;color:#736b6e;line-height:1.7;margin:0;">
        ...
        <tr>
          <td class="mobile-pad" style="padding:0 48px 20px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#4a4446;border-radius:16px;">
              <tr>
                <td style="padding:24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.5);text-transform:uppercase;letter-spacing:2px;margin:0 0 6px;">Refund summary</p>
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:20px;">
                    <tr>
                      <td style="vertical-align:middle;">
                        ...
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:rgba(255,255,255,0.6);margin:6px 0 0;">returning to your original payment method</p>
                      </td>
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid rgba(255,255,255,0.14);">
                    <tr>
                      <td class="detail-cell" style="padding:14px 12px 0 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Event</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.4;">{{event_name}}</p>
                      </td>
                      <td class="detail-cell" style="padding:14px 12px 0 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Ticket</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.4;">{{ticket_name}}</p>
                      ...
                      <td class="detail-cell" style="padding:14px 0 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Processed</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;">{{refund_date}}</p>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          <td class="mobile-pad" style="padding:0 48px 20px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f0fdf4;border-radius:14px;border:1px solid #86efac;">
              <tr>
                <td style="padding:22px 24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#16a34a;text-transform:uppercase;letter-spacing:2.5px;margin:0 0 6px;">What to expect</p>
                      ...
                      <td style="padding:0 0 12px;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          <tr>
                            ...
                            <td style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;color:#4a4446;line-height:1.55;">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f5f0e8;border-radius:14px;border:1px solid rgba(194,153,209,0.35);">
              <tr>
                <td style="padding:22px 24px;">
                  ...
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.65;margin:0 0 16px;">Browse upcoming events across the UK and keep building your network.</p>
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="background:#4a4446;border-radius:999px;">
                        <a href="{{site_url}}/events/" style="display:inline-block;padding:10px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">Browse upcoming events &rarr;</a>
        ...
        <tr>
          <td style="background:#4a4446;padding:22px 48px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Refund sent to your original payment method</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;border-left:1px solid rgba(255,255,255,0.12);border-right:1px solid rgba(255,255,255,0.12);vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Allow up to 10 business days to appear</p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;">Questions? <a href="mailto:hello@the-networker.co.uk" style="color:#ebe0f0;text-decoration:none;">hello@the-networker.co.uk</a></p>
                </td>
...
',
  array['user_name', 'user_email', 'event_name', 'ticket_name', 'refund_amount', 'refund_date', 'sponsor_row', 'site_url', 'logo_url'],
  'attendees'
)
on conflict (slug) do update set
  name = excluded.name,
