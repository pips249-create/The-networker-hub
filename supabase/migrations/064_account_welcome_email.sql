-- Account welcome email + Command Centre attendee/organiser grouping
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">Welcome</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:26px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">Your Hub account is ready</h1>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:400;color:#736b6e;line-height:1.7;margin:0;">
              Hi {{user_name}}, welcome to <strong style="color:#9a7aa8;font-weight:600;">The Networker Hub</strong>. You&rsquo;re all set to discover events, book tickets, and keep everything in one place.
            </p>
          </td>
        </tr>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f5f0e8;border-radius:14px;border:1px solid #d9c4e0;">
              <tr>
                <td style="padding:22px 24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:2px;margin:0 0 12px;">What you can do in My Hub</p>
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td class="feature-cell" style="padding:0 0 12px;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:600;color:#4a4446;margin:0 0 4px;">Upcoming events &amp; tickets</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.6;margin:0;">See what you&rsquo;ve booked and open event details any time.</p>
                      </td>
                    </tr>
                    <tr>
                      <td class="feature-cell" style="padding:12px 0;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:600;color:#4a4446;margin:0 0 4px;">Payments &amp; receipts</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.6;margin:0;">Booking references and payment history in one dashboard.</p>
                      </td>
                    </tr>
                    <tr>
                      <td class="feature-cell" style="padding:12px 0 0;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:14px;font-weight:600;color:#4a4446;margin:0 0 4px;">Saved events &amp; reviews</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:400;color:#736b6e;line-height:1.6;margin:0;">Favourite events to watch and leave feedback after you attend.</p>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 12px;">
              <tr>
                <td style="background:#4a4446;border-radius:999px;">
                  <a href="{{hub_account_url}}" style="display:inline-block;padding:12px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">Go to My Hub &rarr;</a>
                </td>
              </tr>
            </table>
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
              <tr>
                <td style="background:#ffffff;border:1px solid #d9c4e0;border-radius:999px;">
                  <a href="{{browse_events_url}}" style="display:inline-block;padding:10px 24px;font-family:''DM Sans'',system-ui,sans-serif;font-size:12px;font-weight:600;color:#4a4446;text-decoration:none;">Browse upcoming events</a>
                </td>
              </tr>
            </table>
          </td>
