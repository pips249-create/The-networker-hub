-- Booking confirmation email — booking email links
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#4a4446;border-radius:16px;">
              <tr>
                <td style="padding:24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.5);text-transform:uppercase;letter-spacing:2px;margin:0 0 8px;">Your event</p>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="background:#4a4446;border-radius:999px;">
                        <a href="{{browse_events_url}}" style="display:inline-block;padding:10px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">Browse upcoming events &rarr;</a>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;"><a href="{{hub_account_url}}" style="color:#ffffff;text-decoration:none;">Your ticket is saved in your Hub account</a></p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;border-left:1px solid rgba(255,255,255,0.12);border-right:1px solid rgba(255,255,255,0.12);vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;"><a href="{{hub_payment_url}}" style="color:#ffffff;text-decoration:none;">View your payment details</a></p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
