-- Booking confirmation email — refund policy, online/in-person layout, footer band
              ...
              <tr>
                <td style="padding:24px;">
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:4px;">
                    <tr>
                      <td style="padding:0 0 10px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;color:rgba(255,255,255,0.75);line-height:1.5;">
...
',
  placeholders = array[
    ...
    'meeting_link', 'meeting_link_section', 'event_location_row', 'event_online_row',
    'refund_policy_section', 'sponsor_section', 'site_url', 'logo_url'
  ],
  updated_at = now()
