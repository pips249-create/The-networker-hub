-- Saved opportunity — listing closing soon notification email
...
<head>
  ...
  <title>Opportunity closing soon – The Networker Hub</title>
  <style>
    ...
    @media only screen and (max-width:600px) {
      ...
      .email-wrapper { width:100% !important; max-width:100% !important; border-radius:0 !important; box-shadow:none !important; }
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <tr>
          <td class="mobile-header-pad" style="background:#f5f0e8;padding:32px 48px 0;text-align:center;">
            <a href="{{site_url}}/" style="text-decoration:none;display:inline-block;">
              <img src="{{logo_url}}" alt="The Networker Hub" width="240" class="email-logo-header" style="height:auto;display:inline-block;margin:0 auto;border:0;max-width:240px;">
            </a>
          </td>
        </tr>
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 8px;">Saved opportunity</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:28px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">Closing soon</h1>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:400;color:#635c5e;line-height:1.7;margin:0;">
              Hi {{user_name}}, you saved <strong style="color:#9a7aa8;font-weight:600;">{{opportunity_title}}</strong> &mdash; this listing is nearing its expiry date. Send an enquiry before it comes down.
            </p>
          </td>
        </tr>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#1c2040;border-radius:16px;">
              <tr>
                <td style="padding:24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:rgba(255,255,255,0.5);text-transform:uppercase;letter-spacing:1px;margin:0 0 8px;">Your saved listing</p>
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:19px;font-weight:600;color:#ffffff;margin:0 0 16px;line-height:1.3;">{{opportunity_title}}</p>
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td class="detail-cell" style="padding:0 0 10px;font-family:''DM Sans'',system-ui,sans-serif;font-size:15px;color:rgba(255,255,255,0.75);line-height:1.5;">
                        <span style="color:rgba(255,255,255,0.55);">Listed by</span><br>
                        <span style="color:#ffffff;font-weight:600;">{{opportunity_host}}</span>
                      </td>
                    </tr>
                    <tr>
                      <td class="detail-cell" style="padding:0;font-family:''DM Sans'',system-ui,sans-serif;font-size:15px;color:rgba(255,255,255,0.75);line-height:1.5;">
                        <span style="color:rgba(255,255,255,0.55);">Listing expires</span><br>
                        <span style="color:#ffffff;font-weight:600;">{{expiry_date}}</span>
                      </td>
                    </tr>
                  </table>
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-top:18px;">
                    <tr>
                      <td class="email-cta" style="background:#4aa8f0;border-radius:999px;">
                        <a href="{{opportunity_url}}" style="display:inline-block;padding:14px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:#ffffff;text-decoration:none;">Send an enquiry &rarr;</a>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          <td class="mobile-pad email-cta" style="padding:0 48px 24px;text-align:center;">
            <a href="{{hub_account_url}}" style="display:inline-block;padding:14px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:600;color:#4a4446;text-decoration:none;border:1px solid #d9c4e0;border-radius:999px;">View saved opportunities in My Hub</a>
          </td>
        </tr>
        ...
        <tr>
          <td class="mobile-footer-pad" style="background:#f5f0e8;padding:28px 48px 30px;text-align:center;border-radius:0 0 20px 20px;border-top:1px solid rgba(194,153,209,0.35);">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:15px;font-weight:400;color:#635c5e;line-height:1.8;margin:0 0 10px;">
              ...
              Registered in England &amp; Wales &nbsp;&middot;&nbsp; Company No. 15252227 &nbsp;&middot;&nbsp; VAT No. 454 4092 94
            </p>
