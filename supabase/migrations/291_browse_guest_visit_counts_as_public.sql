-- Guest-visit tickets count as public access for members_only_event.
-- A members-only tier + complimentary guest visit is not a closed members-only listing.
...
comment on view public.browse_events_index is
  'Public browse catalogue — Guest-visit tiers count as public access for members_only_event; CE is never members_only_event.';
