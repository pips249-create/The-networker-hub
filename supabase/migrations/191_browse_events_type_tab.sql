-- Restore Masterclass on browse_events_index.type_tab (regressed in 184/188).
-- Drop dead hybrid format_tab branch (removed as a meeting format in 184).
...
-- Align slot-open template placeholders with runtime variables (available_from_note).
