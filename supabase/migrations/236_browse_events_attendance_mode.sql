-- Expose attendance_mode on browse_events_index so Category Exclusivity /
-- guest programme cards keep the correct mode after hydrate (and pins).
...
comment on view public.browse_events_index is
  'Public browse catalogue — includes attendance_mode; CE is never members_only_event.';
