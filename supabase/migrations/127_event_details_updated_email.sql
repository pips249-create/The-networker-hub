-- Notify attendees when organisers update allowed event details after ticket sales
...
values (
  ...
  'Sent to booked attendees when an organiser updates non-material event details (title, description, join link).',
  'Update for {{event_name}}',
  '<!DOCTYPE html>
  ...
  <tr>
    <td align="center" style="padding:32px 16px 56px;">
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(28,32,64,0.12);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 40px 16px;text-align:center;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 16px;">
              <tr><td style="width:52px;height:52px;background:#ebe0f0;border-radius:50%;text-align:center;vertical-align:middle;font-size:24px;color:#9a7aa8;line-height:52px;">&#9998;</td></tr>
            </table>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 8px;">Your booking</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:28px;font-weight:600;color:#1c2040;margin:0 0 10px;line-height:1.15;">Event details updated</h1>
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;line-height:1.7;color:#635c5e;margin:0;">Hi {{user_name}}, the organiser updated details for <strong style="color:#1c2040;">{{event_name}}</strong>. Your date, time, venue, and ticket type are unchanged.</p>
          </td>
        </tr>
        <tr>
          <td class="mobile-pad" style="padding:0 40px 20px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#1c2040;border-radius:16px;">
              <tr>
                <td style="padding:24px;font-family:''DM Sans'',system-ui,sans-serif;font-size:15px;line-height:1.65;color:#ffffff;">
                  {{changes_section}}
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td class="mobile-pad email-cta" style="padding:0 40px 28px;text-align:center;">
            <a href="{{event_url}}" style="display:inline-block;text-align:center;padding:14px 32px;background:#4aa8f0;border-radius:999px;color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;margin:0 6px 10px;">View event &rarr;</a>
            <a href="{{hub_account_url}}" style="display:inline-block;text-align:center;padding:14px 32px;background:#ffffff;border:1px solid #d9c4e0;border-radius:999px;color:#1c2040;font-size:16px;font-weight:700;text-decoration:none;margin:0 6px 10px;">My Hub</a>
          </td>
        </tr>
        {{mini_sponsors_row}}
        <tr>
...
',
  array[
    ...
    'changes_section', 'hub_account_url', 'browse_events_url', 'contact_url', 'privacy_url', 'terms_url',
    'sponsor_row', 'mini_sponsors_row', 'site_url', 'logo_url', 'logo_footer_url'
  ],
  'attendees'
)
