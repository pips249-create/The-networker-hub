-- Organiser new booking alert email
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(28,32,64,0.18);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:#4aa8f0;text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">New booking</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:26px;font-weight:600;color:#1c2040;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">Someone just booked your event</h1>
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid rgba(255,255,255,0.14);">
                    <tr>
                      ...
                      <td class="detail-cell" style="padding:14px 0;width:33.33%;vertical-align:top;">
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:10px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1.5px;margin:0 0 4px;">Booked at</p>
                        <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:600;color:#ffffff;margin:0;">{{booking_time}}</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="background:#1c2040;border-radius:999px;">
                        <a href="{{dashboard_url}}" style="display:inline-block;padding:10px 28px;font-family:''DM Sans'',system-ui,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">Manage attendees &rarr;</a>
                      </td>
                    </tr>
                  </table>
                </td>
