-- Browse cards use browse_events_index (not published_events / events.*).
-- Migration 151 added events.image_position but did not update this view,
-- so recentred cover photos applied on event detail but not on browse.
