-- Category Exclusivity events are not members-only listings, even when they
-- also have a members_only member-price tier.
...
comment on view public.browse_events_index is
  'Public browse catalogue — Category Exclusivity is never flagged members_only_event.';
