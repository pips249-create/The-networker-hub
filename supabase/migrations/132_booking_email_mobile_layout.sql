-- Booking confirmation email — booking email mobile layout
      ...
      <table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(74,68,70,0.10);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:28px 48px 20px;text-align:center;">
            ...
            <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:#9a7aa8;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 8px;">Booking confirmed</p>
            <h1 class="hero-title" style="font-family:''DM Sans'',system-ui,sans-serif;font-size:28px;font-weight:600;color:#4a4446;letter-spacing:-0.03em;line-height:1.15;margin:0 0 10px;">You&rsquo;re booked!</h1>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#4a4446;border-radius:16px;">
              <tr>
                <td style="padding:24px;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:rgba(255,255,255,0.5);text-transform:uppercase;letter-spacing:1px;margin:0 0 8px;">Your event</p>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td style="background:#4a4446;border-radius:999px;">
                        <a href="{{browse_events_url}}" style="display:inline-block;padding:14px 32px;font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:700;color:#ffffff;text-decoration:none;">Browse upcoming events &rarr;</a>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;"><a href="{{hub_account_url}}" style="color:#ffffff;text-decoration:none;">Your ticket is saved in your Hub account</a></p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;border-left:1px solid rgba(255,255,255,0.12);border-right:1px solid rgba(255,255,255,0.12);vertical-align:top;">
                  <p style="font-family:''DM Sans'',system-ui,sans-serif;font-size:16px;font-weight:600;color:#ffffff;margin:0;line-height:1.45;"><a href="{{hub_payment_url}}" style="color:#ffffff;text-decoration:none;">View your payment details</a></p>
                </td>
                <td class="info-cell" style="text-align:center;width:33.33%;padding:0 10px;vertical-align:top;">
        ...
        <tr>
          <td class="mobile-footer-pad" style="background:#f5f0e8;padding:28px 48px 30px;text-align:center;border-radius:0 0 20px 20px;border-top:1px solid rgba(194,153,209,0.35);">
            <a href="{{site_url}}/" style="text-decoration:none;display:inline-block;">
              <img src="{{logo_footer_url}}" alt="The Networker Hub" width="200" class="email-logo-footer" style="height:auto;display:inline-block;margin:0 auto 16px;border:0;max-width:200px;">
            </a>
